...
field_schema:
  ...
  VISUALIZATION:               # Feeds: efficacy-bar / consumer-bar / timeseries-line / region-bar (middle_column). Visualization pages, rendered AFTER all efficacy-table / consumer-block components.
    ...
    efficacy_bar:               # Feeds: efficacy-bar component. Horizontal bar chart.
      ...
      data_source_field: "conviction_performance.{clinical, sensory, instrumental}.results[]"
    ...
    timeseries_line:            # Feeds: timeseries-line component. Multi-line chart.
      ...
      data_source_field: "conviction_performance.{clinical, sensory, instrumental, consumer}.results[].timepoints_data[]"
    ...
    region_bar:                 # Feeds: region-bar component. Bar chart aggregated by region.
      ...
      x_axis: "MEAN percentage_change across all CLINS / FE / INSTRUMENTAL results at the primary timepoint within that region"
      ...
      data_source_field: "conviction_performance.{clinical, sensory, instrumental}.results[].{study_region, timepoints_data[primary]}"
```
