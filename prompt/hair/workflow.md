...
| `summary-block`          | right_column            | `performance_summary` (AI-authored three-part synthesis: `OVERALL` + by-type + by-region)                            | `PROJECT_DETAIL` → `performance_summary`. **`label="Performance Summary"` REQUIRED** — the engine renders it as the card title line. The single card contains `OVERALL` plus a **By-Type** sub-section (one line per present report type: `CLINICAL` / `SENSORY` / `CONSUMER`) plus a **By-Region** sub-section (one line per present ISO country code, upper-cased `study_region`); see **Performance Summary — By-Type & By-Region Contract**.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `custom` (`region=`)   | escape hatch            | anything that does not fit the above                                                                                     | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `efficacy-bar`           | middle_column           | horizontal bar chart, CLINS/FE`percentage_change` at primary timepoint, grouped by study                  | Visualization-only component (rendered AFTER all efficacy-table / consumer-block). Self-titled with one top`<text>` line. Render via d3 → pure SVG elements with inline attributes; ≤ 405 px tall. See the **Visualization Pages** sub-section for data rules.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `consumer-bar`           | middle_column           | horizontal bar chart, CE`acceptance_rate` at primary timepoint, grouped by consumer test                               | Visualization-only component. Self-titled. Render via d3 → pure SVG, inline attributes; ≤ 405 px tall. See the**Visualization Pages** sub-section.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `timeseries-line`        | middle_column           | multi-line chart, x = timepoints, y =`percentage_change`, one line per metric                                          | Visualization-only component. Self-titled. Render via d3 → pure SVG, inline attributes; ≤ 405 px tall; split into`(1/2)` / `(2/2)` if needed. See the **Visualization Pages** sub-section.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `region-bar`             | middle_column           | bar chart aggregated by`study_region` (CN / US / FR / … or `[—]`); each bar = region-mean of `percentage_change` | Visualization-only component. Self-titled. Render via d3 → pure SVG, inline attributes; ≤ 405 px tall. OMIT the component entirely when every JSON result has`study_region: null`. See the **Visualization Pages** sub-section.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
field_schema:
  ...
  PROJECT_DETAIL:              # Feeds: info-card (left_column) · summary-block (right_column) · meta claims block (right_column — communication_claims)
    ...
    - performance_summary:     # AI-authored summary rendered as ONE right-column card. Source strictly from CONVICTION_PERFORMANCE / CONSUMER_PERCEPTION; see the By-Type & By-Region Contract below.
      ...
      regions:                 # object — by-region synthesis; one entry per ISO country code that has at least one result with a non-null study_region in the JSON (CLINS / FE / CE all count). OMIT the entire object (not just empty it) when every result has study_region = null.
                               # Keys are the UPPER-CASED ISO 3166-1 alpha-2 codes as they appear in the JSON's study_region field (e.g. "CN", "US", "FR"). Values are strings: one sentence, up to 30 words, with colored key values. The value MUST begin with the same code as a bold subtitle tspan in the rendered SVG (e.g. "CN: ..."), and the line is a regional cross-cut drawn from across the three report types within that region — do NOT re-state the by-type sentences, do NOT name individual study_names.
  ...
  VISUALIZATION:               # Feeds: efficacy-bar / consumer-bar / timeseries-line / region-bar (middle_column). Visualization pages, rendered AFTER all efficacy-table / consumer-block components.
    data_source: "strictly JSON-only — no external input, no AI inference beyond what is explicitly in @extract's JSON. Every value rendered in any chart must trace back to a JSON field; missing fields render nothing for that bar/point/line."
    color_discipline: "reuse the existing status palette (green #2e7d32 / orange #e07b00 / red #c62828 / neutral #333333) keyed by the JSON color_code of the source value. Never invent colors."
    region_suffix_rule: "every chart's top <text> title line carries the [<study_region>] / [—] suffix per the existing suffix rule (use [—] when JSON study_region is null)."
    self_titled: "each chart's <svg> includes ONE top <text> line describing the chart subject (e.g. 'CLINS Metrics Comparison'). Do NOT use the engine label mechanism (label attribute) for visualization components."
    height_budget: "single-component viewBox height must fit the middle_column ≈ 405 px cap; if a chart would overflow, split into multiple components (e.g. 'timeseries-line (1/2)' / 'timeseries-line (2/2)')."

    efficacy_bar:               # Feeds: efficacy-bar component. Horizontal bar chart.
      group_by: "study (study_name from JSON)"
      y_axis: "metric_name (from JSON results[].metric_name)"
      x_axis: "percentage_change at the PRIMARY timepoint"
      primary_timepoint_rule: "for each metric, the timepoint with the largest absolute percentage_change. Ties: prefer the latest timepoint. Document the rule in the chart's legend <text>."
      series_count: "one bar per (study, metric) pair"
      data_source_field: "conviction_performance.{clinical, sensory}.results[]"

    consumer_bar:               # Feeds: consumer-bar component. Horizontal bar chart.
      group_by: "consumer test (study_name from JSON)"
      y_axis: "metric_name (from JSON consumer results[].metric_name)"
      x_axis: "acceptance_rate at the PRIMARY timepoint (out of 100%)"
      series_count: "one bar per (consumer_test, metric) pair"
      data_source_field: "conviction_performance.consumer.results[]"

    timeseries_line:            # Feeds: timeseries-line component. Multi-line chart.
      group_by: "metric (metric_name from JSON)"
      x_axis: "timepoint (results[].timepoints_data[].time)"
      y_axis: "percentage_change (results[].timepoints_data[].percentage_change)"
      series_count: "one line per metric; if too many metrics to be readable, aggregate by study (one line per (study, metric)) and split into (1/2) / (2/2) components"
      data_source_field: "conviction_performance.{clinical, sensory, consumer}.results[].timepoints_data[]"
      legend: "include a legend <text> block mapping line color → metric_name + study_name"

    region_bar:                 # Feeds: region-bar component. Bar chart aggregated by region.
      group_by: "study_region (from JSON; lowercased ISO 3166-1 alpha-2 code, or null)"
      y_axis: "alpha-2 code upper-cased (CN / US / FR / … or — for the null bucket)"
      x_axis: "MEAN percentage_change across all CLINS / FE results at the primary timepoint within that region"
      aggregation_rule: "arithmetic mean; if a region has only one result, use that result's value. Document the rule in the legend <text>."
      omit_when: "every JSON result has study_region: null → omit the entire region-bar component (no [—] placeholder bar)"
      data_source_field: "conviction_performance.{clinical, sensory}.results[].{study_region, timepoints_data[primary]}"
```
...
1. **Field order and content — mandatory subtitles**
   ...
   - The card is a vertical stack of labeled lines, organized as: 1 `OVERALL` line, then 0–3 by-type lines, then 0–N by-region lines. Every line starts with an **uppercase bold neutral subtitle** rendered as its own `<tspan font-weight="bold">`:
     ...
     - **By-Type sub-section** (one line per present report type, in the fixed order CLINICAL → SENSORY → CONSUMER):
     ...
     - **By-Region sub-section** (one line per present ISO country code, ordered alphabetically ascending by alpha-2 code):
       - `<ISO_CODE>:` one sentence, **up to 30 words**, where `<ISO_CODE>` is the upper-cased ISO 3166-1 alpha-2 country code as recorded in the JSON's `study_region` field (e.g. `CN:`, `US:`, `FR:`, `BR:`, `JP:`, `GB:`, `DE:`, `KR:`, `ES:`, `IT:`, `IN:`, `RU:`, or any out-of-whitelist alpha-2 code the JSON contains). Synthesize the line from all results across **all three** report types (CLINS / FE / CE) whose `study_region` equals that code, aggregated into a single per-region synthesis. Do not name individual `study_name`s; do not duplicate the by-type sentences — a by-region line is a regional cross-cut, not a re-statement of the by-type lines.
   - The subtitle is NOT optional prose styling — every sub-section line MUST begin with its bold tspan (`OVERALL:` / `CLINICAL:` / `SENSORY:` / `CONSUMER:` / `<ISO_CODE>:`) so each section and each report type / region is visually scannable.
...
4. **Compact SVG pattern**
   ...
   - **Total line budget inside the summary card**: with the right-column height cap (≈ 405 px) unchanged, the whole `<svg>` is hard-capped at **~24 visual lines at 8pt / line-height 1.25×** including the engine-rendered `Performance Summary` title row and the 1–2 px gaps between subtitles. This budget is shared across `OVERALL` + present by-type lines + present by-region lines. The two sub-sections are sized roughly equal-share by default: a project with all three by-type lines and ~3 by-region lines lands at ~24 lines; a project with only one by-type and one by-region line lands well under cap. If the sum would exceed ~24 lines, the trimming priority is: ① compress wording to shorter clauses in by-region lines first (they are cross-cuts, more compressible), ② drop secondary metrics from any sub-section that doesn't change interpretation, ③ only as a last resort, reduce OVERALL from 3–5 sentences to a 2-sentence version — **never drop a present report type, never drop a present region, never go below 7pt, and never widen beyond the column's right edge**.

### Visualization Pages (rendered AFTER all efficacy-table / consumer-block components)

These are **optional** components, rendered as the final components inside the `<deck>` after every `efficacy-table` and `consumer-block` has been emitted. They re-present the same JSON data as parallel visualizations; they do NOT introduce new facts and do NOT alter the existing report structure.

1. **Optional emission** — emit 0–1 of each visualization type (`efficacy-bar` / `consumer-bar` / `timeseries-line` / `region-bar`) based on whether the JSON contains the data the chart needs. When a chart's data source is empty or the omit condition is met (e.g. `region-bar` when every `study_region` is null), **omit the entire component** — do not emit an empty chart, do not emit a placeholder.
2. **JSON-only data discipline** — every value rendered in any chart must trace back to a JSON field. Render only what the JSON contains; do not recompute, normalize, or invent derived values. This rule is identical in spirit to constraint #6 (Reference and zero hallucinating) for the existing deck.
3. **No extension of the strong-recall audit** — the existing "Full data fidelity" constraint for CONVICTION_PERFORMANCE is **not** extended to visualization components. The AI is free to choose which data points to chart; the audit's pre-output JSON-vs-SVG count check applies only to `efficacy-table` (and its `study_narrative` footers), not to `efficacy-bar` / `consumer-bar` / `timeseries-line` / `region-bar`.
4. **Region suffix** — every chart's top `<text>` title line carries the `[<study_region>]` / `[—]` suffix per the existing suffix rule. When a chart aggregates across multiple regions (e.g. `region-bar`), the title carries `[—]` (aggregated cross-region).
5. **Self-titled** — each chart's `<svg>` includes ONE top `<text>` line describing the chart subject (e.g. "CLINS Metrics Comparison"). Do NOT use the engine label mechanism (`label` attribute) for visualization components.
6. **Middle column only** — all four visualization types route to `middle_column`. They inherit the existing middle-column pagination logic: the engine continues to repeat `top_banner` / `meta_row` / `left_column` / `right_column` on continuation pages.
7. **Height budget** — single-component viewBox height must fit the middle_column ≈ 405 px cap. If a chart would overflow (e.g. `timeseries-line` with many metrics and many timepoints), split into multiple components named `(1/2)` / `(2/2)` per the existing efficacy-table split pattern.
8. **d3 rendering convention** — produce each chart's SVG by computing the geometry in your head and writing the resulting pure SVG elements directly into the `<svg>`. Do NOT embed `<script>` or rely on SVG-internal JS execution: PyMuPDF rasterizes SVG as a static image and does not run scripts. Do NOT use `<style>` blocks or `class=` attributes: PyMuPDF does not parse CSS selectors. Do NOT reference external `<image>`/URL resources: PyMuPDF silently drops them. The d3 look-and-feel (axis ticks, gridlines, axis labels, bar/line geometry, color keying) is achieved by writing those SVG elements by hand with inline attributes.
9. **Color discipline** — every bar / line segment / point takes its color from the JSON `color_code` of the source value, mapped to the existing status palette (green `#2e7d32` / orange `#e07b00` / red `#c62828` / neutral `#333333`). Neutral axis lines, gridlines, and chart chrome use `#666666` or `#999999`.
10. **Order of emission** — visualization components appear in this fixed order at the end of the deck: `efficacy-bar` → `consumer-bar` → `timeseries-line` → `region-bar`. Skip any type whose data is missing.
